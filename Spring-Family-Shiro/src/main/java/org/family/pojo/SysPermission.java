...
public class SysPermission implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "seq_sys_permission_generator", sequenceName = "seq_sys_permission", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_sys_permission_generator")
    private long id;//主键.
